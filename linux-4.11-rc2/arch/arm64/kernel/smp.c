...
#define S(x,s,f)	[x].desc = s, [x].handler = f
	...
	S(IPI_CALL_FUNC, "Function call interrupts", generic_smp_call_function_interrupt),
	S(IPI_CPU_STOP, "CPU stop interrupts", ipi_cpu_stop),
#ifdef CONFIG_GENERIC_CLOCKEVENTS_BROADCAST
	S(IPI_TIMER, "Timer broadcast interrupts", tick_receive_broadcast_local),
#endif
#ifdef CONFIG_IRQ_WORK
	S(IPI_IRQ_WORK, "IRQ work interrupts", irq_work_run),
#endif
	S(IPI_WAKEUP, "CPU wake-up interrupts", NULL),
};
