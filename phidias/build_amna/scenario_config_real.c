...
__SEC_ROH specification const _specification = {
  "PHIDSPEC", 0x10016000, 0xf4000e000, 0x10022000, 2, _specification_cpus, _specification_irq_owners, &_specification_arch, "2017/07/18 15:23:24"
};
__SEC_RO const vm * const _specification_irq_owners[IRQID_MAXIMUM] = {
};
__SEC_RO specification_arch const _specification_arch = {};
__SEC_RO specification_cpu const _specification_cpus[2] = {
  { 0x10033000, 40, cpu0_memareas, &cpu0_memtree, 2, cpu0_vm_cpus, {} },
  { 0x10042000, 36, cpu1_memareas, &cpu1_memtree, 0, NULL, {} },
};
__SEC_RO memarea const cpu0_memareas[40] = {
  ...
  { 0xe5000, 0xf4000d000, 0x1000, MEMAREA_FLAG_R|MEMAREA_FLAG_W|MEMAREA_FLAG_G, NULL },
  { 0x10014000, 0xf4000c000, 0x1000, MEMAREA_FLAG_R|MEMAREA_FLAG_W|MEMAREA_FLAG_G|MEMAREA_FLAG_S, NULL },
  { 0x10015000, 0xf400e8000, 0x1000, MEMAREA_FLAG_R|MEMAREA_FLAG_G, NULL },
  { 0, 0, 0, 0, NULL },
  { 0x1006d000, 0xf50200000, 0x136c000, MEMAREA_FLAG_R|MEMAREA_FLAG_G, NULL },
  { 0xe9000, 0xf400ec000, 0x1000, MEMAREA_FLAG_R|MEMAREA_FLAG_W|MEMAREA_FLAG_G, NULL },
  { 0x10016000, 0xf4000e000, 0x5000, MEMAREA_FLAG_R|MEMAREA_FLAG_G, NULL },
  { 0xe7000, 0xf40013000, 0x1000, MEMAREA_FLAG_R|MEMAREA_FLAG_W|MEMAREA_FLAG_G, NULL },
  { 0x1001c000, 0xf40014000, 0x1000, MEMAREA_FLAG_R|MEMAREA_FLAG_W|MEMAREA_FLAG_G|MEMAREA_FLAG_S, NULL },
  { 0x1001b000, 0xf400ea000, 0x1000, MEMAREA_FLAG_R|MEMAREA_FLAG_G, NULL },
  { 0x80000, 0xf40057000, 0x40000, MEMAREA_FLAG_R|MEMAREA_FLAG_W|MEMAREA_FLAG_G|MEMAREA_FLAG_S, NULL },
  { 0x0, 0xf40016000, 0x40000, MEMAREA_FLAG_R|MEMAREA_FLAG_W|MEMAREA_FLAG_G, NULL },
  { 0, 0, 0, 0, NULL },
  { 0, 0, 0, 0, NULL },
  { 0xf7113000, 0xf400e6000, 0x1000, MEMAREA_FLAG_R|MEMAREA_FLAG_W|MEMAREA_FLAG_G|MEMAREA_FLAG_D, NULL },
  { 0xf6800000, 0xf400d4000, 0x8000, MEMAREA_FLAG_R|MEMAREA_FLAG_W|MEMAREA_FLAG_G|MEMAREA_FLAG_D, NULL },
  { 0, 0, 0, 0, NULL },
  { 0, 0, 0, 0, NULL },
  { 0, 0, 0, 0, NULL },
  { 0, 0, 0, 0, NULL },
  ...
  { 0, 0, 0, 0, NULL },
  { 0, 0, 0, 0, NULL },
  { 0xf7020000, 0xf400b9000, 0x10000, MEMAREA_FLAG_R|MEMAREA_FLAG_W|MEMAREA_FLAG_G|MEMAREA_FLAG_D, NULL },
  { 0xf8008000, 0xf400ca000, 0x9000, MEMAREA_FLAG_R|MEMAREA_FLAG_W|MEMAREA_FLAG_G|MEMAREA_FLAG_D, NULL },
  { 0xf7030000, 0xf400dd000, 0x2000, MEMAREA_FLAG_R|MEMAREA_FLAG_W|MEMAREA_FLAG_G|MEMAREA_FLAG_D, NULL },
  { 0, 0, 0, 0, NULL },
  { 0, 0, 0, 0, NULL },
  { 0, 0, 0, 0, NULL },
  { 0xf0000000, 0xf40200000, 0xfff0000, MEMAREA_FLAG_R|MEMAREA_FLAG_W|MEMAREA_FLAG_G|MEMAREA_FLAG_D, NULL },
  { 0xc0000, 0xf40098000, 0x20000, MEMAREA_FLAG_R|MEMAREA_FLAG_W|MEMAREA_FLAG_G|MEMAREA_FLAG_S, NULL },
  { 0xe4000, 0xf400ee000, 0x1000, MEMAREA_FLAG_R|MEMAREA_FLAG_W|MEMAREA_FLAG_G|MEMAREA_FLAG_S, NULL },
  { 0xe0000, 0xf400e0000, 0x2000, MEMAREA_FLAG_R|MEMAREA_FLAG_W|MEMAREA_FLAG_G|MEMAREA_FLAG_S, NULL },
  { 0xe2000, 0xf400e3000, 0x2000, MEMAREA_FLAG_R|MEMAREA_FLAG_W|MEMAREA_FLAG_G|MEMAREA_FLAG_S, NULL },
  { 0x11400000, 0x200000, 0x30000000, MEMAREA_FLAG_R|MEMAREA_FLAG_W, NULL },
  { 0xeb000, 0xf400f0000, 0x1000, MEMAREA_FLAG_R|MEMAREA_FLAG_W|MEMAREA_FLAG_G, NULL },
  { 0x41400000, 0x30400000, 0x30000000, MEMAREA_FLAG_R|MEMAREA_FLAG_W, NULL },
  { 0xec000, 0xf400f2000, 0x1000, MEMAREA_FLAG_R|MEMAREA_FLAG_W|MEMAREA_FLAG_G, NULL },
};
__SEC_RO tree_memarea const cpu0_memtree_l_l_l_l = { NULL, NULL, cpu0_memareas + 36 };
__SEC_RO tree_memarea const cpu0_memtree_l_l_l = { &cpu0_memtree_l_l_l_l, &cpu0_memtree_l_l_l_r, cpu0_memareas + 38 };
...
__SEC_RO tree_memarea const cpu0_memtree_l_r_l_r = { NULL, NULL, cpu0_memareas + 13 };
__SEC_RO tree_memarea const cpu0_memtree_l_r = { &cpu0_memtree_l_r_l, &cpu0_memtree_l_r_r, cpu0_memareas + 12 };
__SEC_RO tree_memarea const cpu0_memtree_l_r_r_l = { NULL, NULL, cpu0_memareas + 32 };
__SEC_RO tree_memarea const cpu0_memtree_l_r_r = { &cpu0_memtree_l_r_r_l, NULL, cpu0_memareas + 25 };
__SEC_RO tree_memarea const cpu0_memtree = { &cpu0_memtree_l, &cpu0_memtree_r, cpu0_memareas + 26 };
__SEC_RO tree_memarea const cpu0_memtree_r_l_l_l = { NULL, NULL, cpu0_memareas + 17 };
__SEC_RO tree_memarea const cpu0_memtree_r_l_l = { &cpu0_memtree_r_l_l_l, &cpu0_memtree_r_l_l_r, cpu0_memareas + 27 };
__SEC_RO tree_memarea const cpu0_memtree_r_l_l_r = { NULL, NULL, cpu0_memareas + 34 };
__SEC_RO tree_memarea const cpu0_memtree_r_l = { &cpu0_memtree_r_l_l, &cpu0_memtree_r_l_r, cpu0_memareas + 35 };
...
__SEC_RO tree_memarea const cpu0_memtree_r_r_l = { &cpu0_memtree_r_r_l_l, &cpu0_memtree_r_r_l_r, cpu0_memareas + 39 };
__SEC_RO tree_memarea const cpu0_memtree_r_r_l_r = { NULL, NULL, cpu0_memareas + 37 };
...
__SEC_RO memarea const cpu1_memareas[36] = {
  { 0x10008000, 0xf40000000, 0x9000, MEMAREA_FLAG_R|MEMAREA_FLAG_X|MEMAREA_FLAG_G, NULL },
  { 0x10011000, 0xf40009000, 0x3000, MEMAREA_FLAG_R|MEMAREA_FLAG_G, NULL },
  { 0xe6000, 0xf4000d000, 0x1000, MEMAREA_FLAG_R|MEMAREA_FLAG_W|MEMAREA_FLAG_G, NULL },
  { 0x10014000, 0xf4000c000, 0x1000, MEMAREA_FLAG_R|MEMAREA_FLAG_W|MEMAREA_FLAG_G|MEMAREA_FLAG_S, NULL },
  { 0x10015000, 0xf400e8000, 0x1000, MEMAREA_FLAG_R|MEMAREA_FLAG_G, NULL },
  { 0, 0, 0, 0, NULL },
  { 0x1006d000, 0xf50200000, 0x136c000, MEMAREA_FLAG_R|MEMAREA_FLAG_G, NULL },
  { 0xea000, 0xf400ec000, 0x1000, MEMAREA_FLAG_R|MEMAREA_FLAG_W|MEMAREA_FLAG_G, NULL },
  { 0x10016000, 0xf4000e000, 0x5000, MEMAREA_FLAG_R|MEMAREA_FLAG_G, NULL },
  { 0xe8000, 0xf40013000, 0x1000, MEMAREA_FLAG_R|MEMAREA_FLAG_W|MEMAREA_FLAG_G, NULL },
  { 0x1001c000, 0xf40014000, 0x1000, MEMAREA_FLAG_R|MEMAREA_FLAG_W|MEMAREA_FLAG_G|MEMAREA_FLAG_S, NULL },
  { 0x1001b000, 0xf400ea000, 0x1000, MEMAREA_FLAG_R|MEMAREA_FLAG_G, NULL },
  { 0x80000, 0xf40057000, 0x40000, MEMAREA_FLAG_R|MEMAREA_FLAG_W|MEMAREA_FLAG_G|MEMAREA_FLAG_S, NULL },
  { 0x40000, 0xf40016000, 0x40000, MEMAREA_FLAG_R|MEMAREA_FLAG_W|MEMAREA_FLAG_G, NULL },
  { 0, 0, 0, 0, NULL },
  { 0, 0, 0, 0, NULL },
  { 0xf7113000, 0xf400e6000, 0x1000, MEMAREA_FLAG_R|MEMAREA_FLAG_W|MEMAREA_FLAG_G|MEMAREA_FLAG_D, NULL },
  { 0xf6800000, 0xf400d4000, 0x8000, MEMAREA_FLAG_R|MEMAREA_FLAG_W|MEMAREA_FLAG_G|MEMAREA_FLAG_D, NULL },
...
__SEC_RO tree_memarea const cpu1_memtree_l_l_r_l = { NULL, NULL, cpu1_memareas + 2 };
...
__SEC_RO tree_memarea const cpu1_memtree_l_r_r_l = { NULL, NULL, cpu1_memareas + 32 };
__SEC_RO tree_memarea const cpu1_memtree_l_r_r = { &cpu1_memtree_l_r_r_l, NULL, cpu1_memareas + 25 };
__SEC_RO tree_memarea const cpu1_memtree = { &cpu1_memtree_l, &cpu1_memtree_r, cpu1_memareas + 26 };
__SEC_RO tree_memarea const cpu1_memtree_r_l_l_l = { NULL, NULL, cpu1_memareas + 17 };
__SEC_RO tree_memarea const cpu1_memtree_r_l_l = { &cpu1_memtree_r_l_l_l, NULL, cpu1_memareas + 27 };
__SEC_RO tree_memarea const cpu1_memtree_r_l = { &cpu1_memtree_r_l_l, &cpu1_memtree_r_l_r, cpu1_memareas + 34 };
__SEC_RO tree_memarea const cpu1_memtree_r_l_r_l = { NULL, NULL, cpu1_memareas + 35 };
__SEC_RO tree_memarea const cpu1_memtree_r_l_r = { &cpu1_memtree_r_l_r_l, NULL, cpu1_memareas + 16 };
...
__SEC_RO tree_memarea const cpu1_memtree_r_r_r_l = { NULL, NULL, cpu1_memareas + 31 };
__SEC_RO tree_memarea const cpu1_memtree_r_r_r = { &cpu1_memtree_r_r_r_l, NULL, cpu1_memareas + 6 };
__SEC_RO vm_cpu * const cpu1_vm_cpus[0] = {
};
...
__SEC_RW vm_cpu vm_linux1_cpus[1] = {
  { &vm_linux1, (vm_cpu_state *)0xf400f0000, 0,
    0x10044000, 1,
...
__SEC_RO vm_copyin const vm_linux1_copyins[3] = {
  { 0x280000, 0xf50200000, 0x892808 },
  { 0xa200000, 0xf50a92808, 0xad1958 },
  { 0x208000, 0xf51564160, 0x7df7 },
};
__SEC_RO capability const vm_linux1_capabilities[1] = {
...
__SEC_RO memarea const vm_linux1_cpu0_memareas[7] = {
  { 0x11400000, 0x0, 0x30000000, MEMAREA_FLAG_R|MEMAREA_FLAG_W|MEMAREA_FLAG_X, cpu0_memareas + 36 },
  ...
  { 0xe4000, 0xfee020000, 0x1000, MEMAREA_FLAG_R|MEMAREA_FLAG_W|MEMAREA_FLAG_S, cpu0_memareas + 33 },
  { 0xe0000, 0xfee021000, 0x2000, MEMAREA_FLAG_R|MEMAREA_FLAG_W|MEMAREA_FLAG_S, cpu0_memareas + 34 },
  { 0xe2000, 0xfee023000, 0x2000, MEMAREA_FLAG_R|MEMAREA_FLAG_W|MEMAREA_FLAG_S, cpu0_memareas + 35 },
...
__SEC_RO tree_memarea const vm_linux1_cpu0_memtree_l_r = { NULL, NULL, vm_linux1_cpu0_memareas + 1 };
...
__SEC_RO tree_memarea const vm_linux1_cpu0_memtree_r = { &vm_linux1_cpu0_memtree_r_l, &vm_linux1_cpu0_memtree_r_r, vm_linux1_cpu0_memareas + 4 };
__SEC_RO tree_memarea const vm_linux1_cpu0_memtree_r_r = { NULL, NULL, vm_linux1_cpu0_memareas + 5 };
__SEC_RO emulate const vm_linux1_cpu0_emulates[13] = {
...
__SEC_RW vm_cpu vm_linux2_cpus[1] = {
  { &vm_linux2, (vm_cpu_state *)0xf400f2000, 0,
    0x1004c000, 2,
...
__SEC_RO vm_copyin const vm_linux2_copyins[3] = {
  { 0x30480000, 0xf50200000, 0x892808 },
  { 0x3a400000, 0xf50a92808, 0xad1958 },
  { 0x30408000, 0xf51564160, 0x7df7 },
};
__SEC_RO capability const vm_linux2_capabilities[1] = {
...
__SEC_RO memarea const vm_linux2_cpu0_memareas[6] = {
  { 0x41400000, 0x0, 0x30000000, MEMAREA_FLAG_R|MEMAREA_FLAG_W|MEMAREA_FLAG_X, cpu0_memareas + 38 },
  { 0xc0000, 0xfee000000, 0x20000, MEMAREA_FLAG_R|MEMAREA_FLAG_W|MEMAREA_FLAG_S, cpu0_memareas + 32 },
  { 0xe4000, 0xfee020000, 0x1000, MEMAREA_FLAG_R|MEMAREA_FLAG_W|MEMAREA_FLAG_S, cpu0_memareas + 33 },
  { 0xe0000, 0xfee021000, 0x2000, MEMAREA_FLAG_R|MEMAREA_FLAG_W|MEMAREA_FLAG_S, cpu0_memareas + 34 },
  { 0xe2000, 0xfee023000, 0x2000, MEMAREA_FLAG_R|MEMAREA_FLAG_W|MEMAREA_FLAG_S, cpu0_memareas + 35 },
