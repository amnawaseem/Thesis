...
__SEC_RO memarea const vm_linux1_cpu0_memareas[3];
...
__SEC_ROH specification const _specification = {
  "PHIDSPEC", 0x10016000, 0xf4000e000, 0x10023000, 8, _specification_cpus, _specification_irq_owners, &_specification_arch, "2017/06/28 16:53:50"
};
__SEC_RO const vm * const _specification_irq_owners[IRQID_MAXIMUM] = {
};
__SEC_RO specification_arch const _specification_arch = {};
__SEC_RO specification_cpu const _specification_cpus[8] = {
  { 0x1002d000, 34, cpu0_memareas, &cpu0_memtree, 1, cpu0_vm_cpus, {} },
  { 0x10037000, 32, cpu1_memareas, &cpu1_memtree, 0, NULL, {} },
  { 0x10041000, 32, cpu2_memareas, &cpu2_memtree, 0, NULL, {} },
  { 0x1004b000, 32, cpu3_memareas, &cpu3_memtree, 0, NULL, {} },
  { 0x10055000, 32, cpu4_memareas, &cpu4_memtree, 0, NULL, {} },
  { 0x1005f000, 32, cpu5_memareas, &cpu5_memtree, 0, NULL, {} },
  { 0x10069000, 32, cpu6_memareas, &cpu6_memtree, 0, NULL, {} },
  { 0x10073000, 32, cpu7_memareas, &cpu7_memtree, 0, NULL, {} },
};
__SEC_RO memarea const cpu0_memareas[34] = {
  ...
  { 0x240000, 0xf4000d000, 0x1000, MEMAREA_FLAG_R|MEMAREA_FLAG_W|MEMAREA_FLAG_G, NULL },
  { 0x10014000, 0xf4000c000, 0x1000, MEMAREA_FLAG_R|MEMAREA_FLAG_W|MEMAREA_FLAG_G|MEMAREA_FLAG_S, NULL },
  { 0x10015000, 0xf400c2000, 0x1000, MEMAREA_FLAG_R|MEMAREA_FLAG_G, NULL },
  { 0, 0, 0, 0, NULL },
  { 0x100be000, 0xf50200000, 0x9f3000, MEMAREA_FLAG_R|MEMAREA_FLAG_G, NULL },
  { 0x250000, 0xf400c6000, 0x1000, MEMAREA_FLAG_R|MEMAREA_FLAG_W|MEMAREA_FLAG_G, NULL },
  { 0x10016000, 0xf4000e000, 0x6000, MEMAREA_FLAG_R|MEMAREA_FLAG_G, NULL },
  { 0x248000, 0xf40014000, 0x1000, MEMAREA_FLAG_R|MEMAREA_FLAG_W|MEMAREA_FLAG_G, NULL },
  { 0x1001d000, 0xf40015000, 0x1000, MEMAREA_FLAG_R|MEMAREA_FLAG_W|MEMAREA_FLAG_G|MEMAREA_FLAG_S, NULL },
  { 0x1001c000, 0xf400c4000, 0x1000, MEMAREA_FLAG_R|MEMAREA_FLAG_G, NULL },
  { 0x200000, 0xf40058000, 0x40000, MEMAREA_FLAG_R|MEMAREA_FLAG_W|MEMAREA_FLAG_G|MEMAREA_FLAG_S, NULL },
  { 0x0, 0xf40017000, 0x40000, MEMAREA_FLAG_R|MEMAREA_FLAG_W|MEMAREA_FLAG_G, NULL },
  { 0, 0, 0, 0, NULL },
  { 0, 0, 0, 0, NULL },
  { 0xf7113000, 0xf400c0000, 0x1000, MEMAREA_FLAG_R|MEMAREA_FLAG_W|MEMAREA_FLAG_G|MEMAREA_FLAG_D, NULL },
  { 0xf6800000, 0xf400b4000, 0x8000, MEMAREA_FLAG_R|MEMAREA_FLAG_W|MEMAREA_FLAG_G|MEMAREA_FLAG_D, NULL },
  { 0, 0, 0, 0, NULL },
  { 0, 0, 0, 0, NULL },
  { 0, 0, 0, 0, NULL },
  { 0, 0, 0, 0, NULL },
  ...
  { 0, 0, 0, 0, NULL },
  { 0, 0, 0, 0, NULL },
  { 0xf7020000, 0xf40099000, 0x10000, MEMAREA_FLAG_R|MEMAREA_FLAG_W|MEMAREA_FLAG_G|MEMAREA_FLAG_D, NULL },
  { 0xf8008000, 0xf400aa000, 0x9000, MEMAREA_FLAG_R|MEMAREA_FLAG_W|MEMAREA_FLAG_G|MEMAREA_FLAG_D, NULL },
  { 0xf7030000, 0xf400bd000, 0x2000, MEMAREA_FLAG_R|MEMAREA_FLAG_W|MEMAREA_FLAG_G|MEMAREA_FLAG_D, NULL },
  { 0, 0, 0, 0, NULL },
  { 0, 0, 0, 0, NULL },
  { 0, 0, 0, 0, NULL },
  { 0xf0000000, 0xf40200000, 0xfff0000, MEMAREA_FLAG_R|MEMAREA_FLAG_W|MEMAREA_FLAG_G|MEMAREA_FLAG_D, NULL },
  { 0x40000000, 0x40000000, 0x40000000, MEMAREA_FLAG_R|MEMAREA_FLAG_W, NULL },
  { 0x258000, 0xf400c8000, 0x1000, MEMAREA_FLAG_R|MEMAREA_FLAG_W|MEMAREA_FLAG_G, NULL },
};
__SEC_RO tree_memarea const cpu0_memtree_l_l_l_l = { NULL, NULL, cpu0_memareas + 32 };
__SEC_RO tree_memarea const cpu0_memtree_l_l_l = { &cpu0_memtree_l_l_l_l, NULL, cpu0_memareas + 0 };
...
__SEC_RO tree_memarea const cpu0_memtree_l_r_r = { NULL, NULL, cpu0_memareas + 12 };
...
__SEC_RO tree_memarea const cpu0_memtree_r_l_l = { &cpu0_memtree_r_l_l_l, NULL, cpu0_memareas + 17 };
__SEC_RO tree_memarea const cpu0_memtree_r_l = { &cpu0_memtree_r_l_l, &cpu0_memtree_r_l_r, cpu0_memareas + 27 };
__SEC_RO tree_memarea const cpu0_memtree_r_l_r_l = { NULL, NULL, cpu0_memareas + 16 };
__SEC_RO tree_memarea const cpu0_memtree_r_l_r = { &cpu0_memtree_r_l_r_l, NULL, cpu0_memareas + 4 };
__SEC_RO tree_memarea const cpu0_memtree_r = { &cpu0_memtree_r_l, &cpu0_memtree_r_r, cpu0_memareas + 11 };
__SEC_RO tree_memarea const cpu0_memtree_r_r_l_l = { NULL, NULL, cpu0_memareas + 7 };
__SEC_RO tree_memarea const cpu0_memtree_r_r_l = { &cpu0_memtree_r_r_l_l, NULL, cpu0_memareas + 33 };
__SEC_RO tree_memarea const cpu0_memtree_r_r = { &cpu0_memtree_r_r_l, &cpu0_memtree_r_r_r, cpu0_memareas + 31 };
__SEC_RO tree_memarea const cpu0_memtree_r_r_r = { NULL, NULL, cpu0_memareas + 6 };
__SEC_RO vm_cpu * const cpu0_vm_cpus[1] = {
  vm_linux1_cpus + 0,
};
__SEC_RO memarea const cpu1_memareas[32] = {
  { 0x10008000, 0xf40000000, 0x9000, MEMAREA_FLAG_R|MEMAREA_FLAG_X|MEMAREA_FLAG_G, NULL },
  { 0x10011000, 0xf40009000, 0x3000, MEMAREA_FLAG_R|MEMAREA_FLAG_G, NULL },
  { 0x241000, 0xf4000d000, 0x1000, MEMAREA_FLAG_R|MEMAREA_FLAG_W|MEMAREA_FLAG_G, NULL },
  { 0x10014000, 0xf4000c000, 0x1000, MEMAREA_FLAG_R|MEMAREA_FLAG_W|MEMAREA_FLAG_G|MEMAREA_FLAG_S, NULL },
  { 0x10015000, 0xf400c2000, 0x1000, MEMAREA_FLAG_R|MEMAREA_FLAG_G, NULL },
  { 0, 0, 0, 0, NULL },
  { 0x100be000, 0xf50200000, 0x9f3000, MEMAREA_FLAG_R|MEMAREA_FLAG_G, NULL },
  { 0x251000, 0xf400c6000, 0x1000, MEMAREA_FLAG_R|MEMAREA_FLAG_W|MEMAREA_FLAG_G, NULL },
  { 0x10016000, 0xf4000e000, 0x6000, MEMAREA_FLAG_R|MEMAREA_FLAG_G, NULL },
  { 0x249000, 0xf40014000, 0x1000, MEMAREA_FLAG_R|MEMAREA_FLAG_W|MEMAREA_FLAG_G, NULL },
  { 0x1001d000, 0xf40015000, 0x1000, MEMAREA_FLAG_R|MEMAREA_FLAG_W|MEMAREA_FLAG_G|MEMAREA_FLAG_S, NULL },
  { 0x1001c000, 0xf400c4000, 0x1000, MEMAREA_FLAG_R|MEMAREA_FLAG_G, NULL },
  { 0x200000, 0xf40058000, 0x40000, MEMAREA_FLAG_R|MEMAREA_FLAG_W|MEMAREA_FLAG_G|MEMAREA_FLAG_S, NULL },
  { 0x40000, 0xf40017000, 0x40000, MEMAREA_FLAG_R|MEMAREA_FLAG_W|MEMAREA_FLAG_G, NULL },
  { 0, 0, 0, 0, NULL },
  { 0, 0, 0, 0, NULL },
  { 0xf7113000, 0xf400c0000, 0x1000, MEMAREA_FLAG_R|MEMAREA_FLAG_W|MEMAREA_FLAG_G|MEMAREA_FLAG_D, NULL },
  { 0xf6800000, 0xf400b4000, 0x8000, MEMAREA_FLAG_R|MEMAREA_FLAG_W|MEMAREA_FLAG_G|MEMAREA_FLAG_D, NULL },
...
__SEC_RO tree_memarea const cpu1_memtree_l_l = { &cpu1_memtree_l_l_l, &cpu1_memtree_l_l_r, cpu1_memareas + 3 };
__SEC_RO tree_memarea const cpu1_memtree_l_l_r = { NULL, NULL, cpu1_memareas + 2 };
__SEC_RO tree_memarea const cpu1_memtree_l = { &cpu1_memtree_l_l, &cpu1_memtree_l_r, cpu1_memareas + 8 };
__SEC_RO tree_memarea const cpu1_memtree_l_r_l_l = { NULL, NULL, cpu1_memareas + 9 };
__SEC_RO tree_memarea const cpu1_memtree_l_r_l = { &cpu1_memtree_l_r_l_l, NULL, cpu1_memareas + 10 };
__SEC_RO tree_memarea const cpu1_memtree_l_r = { &cpu1_memtree_l_r_l, &cpu1_memtree_l_r_r, cpu1_memareas + 13 };
__SEC_RO tree_memarea const cpu1_memtree_l_r_r = { NULL, NULL, cpu1_memareas + 12 };
...
__SEC_RO tree_memarea const cpu1_memtree_r_l = { &cpu1_memtree_r_l_l, &cpu1_memtree_r_l_r, cpu1_memareas + 27 };
__SEC_RO tree_memarea const cpu1_memtree_r_l_r = { NULL, NULL, cpu1_memareas + 16 };
__SEC_RO tree_memarea const cpu1_memtree_r = { &cpu1_memtree_r_l, &cpu1_memtree_r_r, cpu1_memareas + 4 };
__SEC_RO tree_memarea const cpu1_memtree_r_r_l_l = { NULL, NULL, cpu1_memareas + 11 };
...
__SEC_RO memarea const cpu2_memareas[32] = {
  { 0x10008000, 0xf40000000, 0x9000, MEMAREA_FLAG_R|MEMAREA_FLAG_X|MEMAREA_FLAG_G, NULL },
  { 0x10011000, 0xf40009000, 0x3000, MEMAREA_FLAG_R|MEMAREA_FLAG_G, NULL },
  { 0x242000, 0xf4000d000, 0x1000, MEMAREA_FLAG_R|MEMAREA_FLAG_W|MEMAREA_FLAG_G, NULL },
  { 0x10014000, 0xf4000c000, 0x1000, MEMAREA_FLAG_R|MEMAREA_FLAG_W|MEMAREA_FLAG_G|MEMAREA_FLAG_S, NULL },
  { 0x10015000, 0xf400c2000, 0x1000, MEMAREA_FLAG_R|MEMAREA_FLAG_G, NULL },
  { 0, 0, 0, 0, NULL },
  { 0x100be000, 0xf50200000, 0x9f3000, MEMAREA_FLAG_R|MEMAREA_FLAG_G, NULL },
  { 0x252000, 0xf400c6000, 0x1000, MEMAREA_FLAG_R|MEMAREA_FLAG_W|MEMAREA_FLAG_G, NULL },
  { 0x10016000, 0xf4000e000, 0x6000, MEMAREA_FLAG_R|MEMAREA_FLAG_G, NULL },
  { 0x24a000, 0xf40014000, 0x1000, MEMAREA_FLAG_R|MEMAREA_FLAG_W|MEMAREA_FLAG_G, NULL },
  { 0x1001d000, 0xf40015000, 0x1000, MEMAREA_FLAG_R|MEMAREA_FLAG_W|MEMAREA_FLAG_G|MEMAREA_FLAG_S, NULL },
  { 0x1001c000, 0xf400c4000, 0x1000, MEMAREA_FLAG_R|MEMAREA_FLAG_G, NULL },
  { 0x200000, 0xf40058000, 0x40000, MEMAREA_FLAG_R|MEMAREA_FLAG_W|MEMAREA_FLAG_G|MEMAREA_FLAG_S, NULL },
  { 0x80000, 0xf40017000, 0x40000, MEMAREA_FLAG_R|MEMAREA_FLAG_W|MEMAREA_FLAG_G, NULL },
  { 0, 0, 0, 0, NULL },
  { 0, 0, 0, 0, NULL },
  { 0xf7113000, 0xf400c0000, 0x1000, MEMAREA_FLAG_R|MEMAREA_FLAG_W|MEMAREA_FLAG_G|MEMAREA_FLAG_D, NULL },
  { 0xf6800000, 0xf400b4000, 0x8000, MEMAREA_FLAG_R|MEMAREA_FLAG_W|MEMAREA_FLAG_G|MEMAREA_FLAG_D, NULL },
...
__SEC_RO tree_memarea const cpu2_memtree_l_l_l_l = { NULL, NULL, cpu2_memareas + 0 };
__SEC_RO tree_memarea const cpu2_memtree_l_l_l = { &cpu2_memtree_l_l_l_l, NULL, cpu2_memareas + 1 };
__SEC_RO tree_memarea const cpu2_memtree_l_l = { &cpu2_memtree_l_l_l, &cpu2_memtree_l_l_r, cpu2_memareas + 3 };
__SEC_RO tree_memarea const cpu2_memtree_l_l_r = { NULL, NULL, cpu2_memareas + 2 };
__SEC_RO tree_memarea const cpu2_memtree_l = { &cpu2_memtree_l_l, &cpu2_memtree_l_r, cpu2_memareas + 8 };
__SEC_RO tree_memarea const cpu2_memtree_l_r_l_l = { NULL, NULL, cpu2_memareas + 9 };
__SEC_RO tree_memarea const cpu2_memtree_l_r_l = { &cpu2_memtree_l_r_l_l, NULL, cpu2_memareas + 10 };
__SEC_RO tree_memarea const cpu2_memtree_l_r = { &cpu2_memtree_l_r_l, &cpu2_memtree_l_r_r, cpu2_memareas + 13 };
__SEC_RO tree_memarea const cpu2_memtree_l_r_r = { NULL, NULL, cpu2_memareas + 12 };
__SEC_RO tree_memarea const cpu2_memtree = { &cpu2_memtree_l, &cpu2_memtree_r, cpu2_memareas + 25 };
__SEC_RO tree_memarea const cpu2_memtree_r_l_l_l = { NULL, NULL, cpu2_memareas + 26 };
__SEC_RO tree_memarea const cpu2_memtree_r_l_l = { &cpu2_memtree_r_l_l_l, NULL, cpu2_memareas + 17 };
__SEC_RO tree_memarea const cpu2_memtree_r_l = { &cpu2_memtree_r_l_l, &cpu2_memtree_r_l_r, cpu2_memareas + 27 };
__SEC_RO tree_memarea const cpu2_memtree_r_l_r = { NULL, NULL, cpu2_memareas + 16 };
__SEC_RO tree_memarea const cpu2_memtree_r = { &cpu2_memtree_r_l, &cpu2_memtree_r_r, cpu2_memareas + 4 };
__SEC_RO tree_memarea const cpu2_memtree_r_r_l_l = { NULL, NULL, cpu2_memareas + 11 };
__SEC_RO tree_memarea const cpu2_memtree_r_r_l = { &cpu2_memtree_r_r_l_l, NULL, cpu2_memareas + 7 };
__SEC_RO tree_memarea const cpu2_memtree_r_r = { &cpu2_memtree_r_r_l, &cpu2_memtree_r_r_r, cpu2_memareas + 31 };
__SEC_RO tree_memarea const cpu2_memtree_r_r_r = { NULL, NULL, cpu2_memareas + 6 };
__SEC_RO vm_cpu * const cpu2_vm_cpus[0] = {
};
__SEC_RO memarea const cpu3_memareas[32] = {
  { 0x10008000, 0xf40000000, 0x9000, MEMAREA_FLAG_R|MEMAREA_FLAG_X|MEMAREA_FLAG_G, NULL },
  { 0x10011000, 0xf40009000, 0x3000, MEMAREA_FLAG_R|MEMAREA_FLAG_G, NULL },
  { 0x243000, 0xf4000d000, 0x1000, MEMAREA_FLAG_R|MEMAREA_FLAG_W|MEMAREA_FLAG_G, NULL },
  { 0x10014000, 0xf4000c000, 0x1000, MEMAREA_FLAG_R|MEMAREA_FLAG_W|MEMAREA_FLAG_G|MEMAREA_FLAG_S, NULL },
  { 0x10015000, 0xf400c2000, 0x1000, MEMAREA_FLAG_R|MEMAREA_FLAG_G, NULL },
  { 0, 0, 0, 0, NULL },
  { 0x100be000, 0xf50200000, 0x9f3000, MEMAREA_FLAG_R|MEMAREA_FLAG_G, NULL },
  { 0x253000, 0xf400c6000, 0x1000, MEMAREA_FLAG_R|MEMAREA_FLAG_W|MEMAREA_FLAG_G, NULL },
  { 0x10016000, 0xf4000e000, 0x6000, MEMAREA_FLAG_R|MEMAREA_FLAG_G, NULL },
  { 0x24b000, 0xf40014000, 0x1000, MEMAREA_FLAG_R|MEMAREA_FLAG_W|MEMAREA_FLAG_G, NULL },
  { 0x1001d000, 0xf40015000, 0x1000, MEMAREA_FLAG_R|MEMAREA_FLAG_W|MEMAREA_FLAG_G|MEMAREA_FLAG_S, NULL },
  { 0x1001c000, 0xf400c4000, 0x1000, MEMAREA_FLAG_R|MEMAREA_FLAG_G, NULL },
  { 0x200000, 0xf40058000, 0x40000, MEMAREA_FLAG_R|MEMAREA_FLAG_W|MEMAREA_FLAG_G|MEMAREA_FLAG_S, NULL },
  { 0xc0000, 0xf40017000, 0x40000, MEMAREA_FLAG_R|MEMAREA_FLAG_W|MEMAREA_FLAG_G, NULL },
  { 0, 0, 0, 0, NULL },
  { 0, 0, 0, 0, NULL },
  { 0xf7113000, 0xf400c0000, 0x1000, MEMAREA_FLAG_R|MEMAREA_FLAG_W|MEMAREA_FLAG_G|MEMAREA_FLAG_D, NULL },
  { 0xf6800000, 0xf400b4000, 0x8000, MEMAREA_FLAG_R|MEMAREA_FLAG_W|MEMAREA_FLAG_G|MEMAREA_FLAG_D, NULL },
...
__SEC_RO tree_memarea const cpu3_memtree_l_l_l_l = { NULL, NULL, cpu3_memareas + 0 };
__SEC_RO tree_memarea const cpu3_memtree_l_l_l = { &cpu3_memtree_l_l_l_l, NULL, cpu3_memareas + 1 };
__SEC_RO tree_memarea const cpu3_memtree_l_l = { &cpu3_memtree_l_l_l, &cpu3_memtree_l_l_r, cpu3_memareas + 3 };
__SEC_RO tree_memarea const cpu3_memtree_l_l_r = { NULL, NULL, cpu3_memareas + 2 };
__SEC_RO tree_memarea const cpu3_memtree_l = { &cpu3_memtree_l_l, &cpu3_memtree_l_r, cpu3_memareas + 8 };
__SEC_RO tree_memarea const cpu3_memtree_l_r_l_l = { NULL, NULL, cpu3_memareas + 9 };
__SEC_RO tree_memarea const cpu3_memtree_l_r_l = { &cpu3_memtree_l_r_l_l, NULL, cpu3_memareas + 10 };
__SEC_RO tree_memarea const cpu3_memtree_l_r = { &cpu3_memtree_l_r_l, &cpu3_memtree_l_r_r, cpu3_memareas + 13 };
__SEC_RO tree_memarea const cpu3_memtree_l_r_r = { NULL, NULL, cpu3_memareas + 12 };
__SEC_RO tree_memarea const cpu3_memtree = { &cpu3_memtree_l, &cpu3_memtree_r, cpu3_memareas + 25 };
__SEC_RO tree_memarea const cpu3_memtree_r_l_l_l = { NULL, NULL, cpu3_memareas + 26 };
__SEC_RO tree_memarea const cpu3_memtree_r_l_l = { &cpu3_memtree_r_l_l_l, NULL, cpu3_memareas + 17 };
__SEC_RO tree_memarea const cpu3_memtree_r_l = { &cpu3_memtree_r_l_l, &cpu3_memtree_r_l_r, cpu3_memareas + 27 };
__SEC_RO tree_memarea const cpu3_memtree_r_l_r = { NULL, NULL, cpu3_memareas + 16 };
__SEC_RO tree_memarea const cpu3_memtree_r = { &cpu3_memtree_r_l, &cpu3_memtree_r_r, cpu3_memareas + 4 };
__SEC_RO tree_memarea const cpu3_memtree_r_r_l_l = { NULL, NULL, cpu3_memareas + 11 };
__SEC_RO tree_memarea const cpu3_memtree_r_r_l = { &cpu3_memtree_r_r_l_l, NULL, cpu3_memareas + 7 };
__SEC_RO tree_memarea const cpu3_memtree_r_r = { &cpu3_memtree_r_r_l, &cpu3_memtree_r_r_r, cpu3_memareas + 31 };
__SEC_RO tree_memarea const cpu3_memtree_r_r_r = { NULL, NULL, cpu3_memareas + 6 };
__SEC_RO vm_cpu * const cpu3_vm_cpus[0] = {
};
__SEC_RO memarea const cpu4_memareas[32] = {
  { 0x10008000, 0xf40000000, 0x9000, MEMAREA_FLAG_R|MEMAREA_FLAG_X|MEMAREA_FLAG_G, NULL },
  { 0x10011000, 0xf40009000, 0x3000, MEMAREA_FLAG_R|MEMAREA_FLAG_G, NULL },
  { 0x244000, 0xf4000d000, 0x1000, MEMAREA_FLAG_R|MEMAREA_FLAG_W|MEMAREA_FLAG_G, NULL },
  { 0x10014000, 0xf4000c000, 0x1000, MEMAREA_FLAG_R|MEMAREA_FLAG_W|MEMAREA_FLAG_G|MEMAREA_FLAG_S, NULL },
  { 0x10015000, 0xf400c2000, 0x1000, MEMAREA_FLAG_R|MEMAREA_FLAG_G, NULL },
  { 0, 0, 0, 0, NULL },
  { 0x100be000, 0xf50200000, 0x9f3000, MEMAREA_FLAG_R|MEMAREA_FLAG_G, NULL },
  { 0x254000, 0xf400c6000, 0x1000, MEMAREA_FLAG_R|MEMAREA_FLAG_W|MEMAREA_FLAG_G, NULL },
  { 0x10016000, 0xf4000e000, 0x6000, MEMAREA_FLAG_R|MEMAREA_FLAG_G, NULL },
  { 0x24c000, 0xf40014000, 0x1000, MEMAREA_FLAG_R|MEMAREA_FLAG_W|MEMAREA_FLAG_G, NULL },
  { 0x1001d000, 0xf40015000, 0x1000, MEMAREA_FLAG_R|MEMAREA_FLAG_W|MEMAREA_FLAG_G|MEMAREA_FLAG_S, NULL },
  { 0x1001c000, 0xf400c4000, 0x1000, MEMAREA_FLAG_R|MEMAREA_FLAG_G, NULL },
  { 0x200000, 0xf40058000, 0x40000, MEMAREA_FLAG_R|MEMAREA_FLAG_W|MEMAREA_FLAG_G|MEMAREA_FLAG_S, NULL },
  { 0x100000, 0xf40017000, 0x40000, MEMAREA_FLAG_R|MEMAREA_FLAG_W|MEMAREA_FLAG_G, NULL },
  { 0, 0, 0, 0, NULL },
  { 0, 0, 0, 0, NULL },
  { 0xf7113000, 0xf400c0000, 0x1000, MEMAREA_FLAG_R|MEMAREA_FLAG_W|MEMAREA_FLAG_G|MEMAREA_FLAG_D, NULL },
  { 0xf6800000, 0xf400b4000, 0x8000, MEMAREA_FLAG_R|MEMAREA_FLAG_W|MEMAREA_FLAG_G|MEMAREA_FLAG_D, NULL },
...
__SEC_RO tree_memarea const cpu4_memtree_l_l_l_l = { NULL, NULL, cpu4_memareas + 0 };
__SEC_RO tree_memarea const cpu4_memtree_l_l_l = { &cpu4_memtree_l_l_l_l, NULL, cpu4_memareas + 1 };
__SEC_RO tree_memarea const cpu4_memtree_l_l = { &cpu4_memtree_l_l_l, &cpu4_memtree_l_l_r, cpu4_memareas + 3 };
__SEC_RO tree_memarea const cpu4_memtree_l_l_r = { NULL, NULL, cpu4_memareas + 2 };
__SEC_RO tree_memarea const cpu4_memtree_l = { &cpu4_memtree_l_l, &cpu4_memtree_l_r, cpu4_memareas + 8 };
__SEC_RO tree_memarea const cpu4_memtree_l_r_l_l = { NULL, NULL, cpu4_memareas + 9 };
__SEC_RO tree_memarea const cpu4_memtree_l_r_l = { &cpu4_memtree_l_r_l_l, NULL, cpu4_memareas + 10 };
__SEC_RO tree_memarea const cpu4_memtree_l_r = { &cpu4_memtree_l_r_l, &cpu4_memtree_l_r_r, cpu4_memareas + 13 };
__SEC_RO tree_memarea const cpu4_memtree_l_r_r = { NULL, NULL, cpu4_memareas + 12 };
__SEC_RO tree_memarea const cpu4_memtree = { &cpu4_memtree_l, &cpu4_memtree_r, cpu4_memareas + 25 };
__SEC_RO tree_memarea const cpu4_memtree_r_l_l_l = { NULL, NULL, cpu4_memareas + 26 };
__SEC_RO tree_memarea const cpu4_memtree_r_l_l = { &cpu4_memtree_r_l_l_l, NULL, cpu4_memareas + 17 };
__SEC_RO tree_memarea const cpu4_memtree_r_l = { &cpu4_memtree_r_l_l, &cpu4_memtree_r_l_r, cpu4_memareas + 27 };
__SEC_RO tree_memarea const cpu4_memtree_r_l_r = { NULL, NULL, cpu4_memareas + 16 };
__SEC_RO tree_memarea const cpu4_memtree_r = { &cpu4_memtree_r_l, &cpu4_memtree_r_r, cpu4_memareas + 4 };
__SEC_RO tree_memarea const cpu4_memtree_r_r_l_l = { NULL, NULL, cpu4_memareas + 11 };
__SEC_RO tree_memarea const cpu4_memtree_r_r_l = { &cpu4_memtree_r_r_l_l, NULL, cpu4_memareas + 7 };
__SEC_RO tree_memarea const cpu4_memtree_r_r = { &cpu4_memtree_r_r_l, &cpu4_memtree_r_r_r, cpu4_memareas + 31 };
__SEC_RO tree_memarea const cpu4_memtree_r_r_r = { NULL, NULL, cpu4_memareas + 6 };
__SEC_RO vm_cpu * const cpu4_vm_cpus[0] = {
};
__SEC_RO memarea const cpu5_memareas[32] = {
  { 0x10008000, 0xf40000000, 0x9000, MEMAREA_FLAG_R|MEMAREA_FLAG_X|MEMAREA_FLAG_G, NULL },
  { 0x10011000, 0xf40009000, 0x3000, MEMAREA_FLAG_R|MEMAREA_FLAG_G, NULL },
  { 0x245000, 0xf4000d000, 0x1000, MEMAREA_FLAG_R|MEMAREA_FLAG_W|MEMAREA_FLAG_G, NULL },
  { 0x10014000, 0xf4000c000, 0x1000, MEMAREA_FLAG_R|MEMAREA_FLAG_W|MEMAREA_FLAG_G|MEMAREA_FLAG_S, NULL },
  { 0x10015000, 0xf400c2000, 0x1000, MEMAREA_FLAG_R|MEMAREA_FLAG_G, NULL },
  { 0, 0, 0, 0, NULL },
  { 0x100be000, 0xf50200000, 0x9f3000, MEMAREA_FLAG_R|MEMAREA_FLAG_G, NULL },
  { 0x255000, 0xf400c6000, 0x1000, MEMAREA_FLAG_R|MEMAREA_FLAG_W|MEMAREA_FLAG_G, NULL },
  { 0x10016000, 0xf4000e000, 0x6000, MEMAREA_FLAG_R|MEMAREA_FLAG_G, NULL },
  { 0x24d000, 0xf40014000, 0x1000, MEMAREA_FLAG_R|MEMAREA_FLAG_W|MEMAREA_FLAG_G, NULL },
  { 0x1001d000, 0xf40015000, 0x1000, MEMAREA_FLAG_R|MEMAREA_FLAG_W|MEMAREA_FLAG_G|MEMAREA_FLAG_S, NULL },
  { 0x1001c000, 0xf400c4000, 0x1000, MEMAREA_FLAG_R|MEMAREA_FLAG_G, NULL },
  { 0x200000, 0xf40058000, 0x40000, MEMAREA_FLAG_R|MEMAREA_FLAG_W|MEMAREA_FLAG_G|MEMAREA_FLAG_S, NULL },
  { 0x140000, 0xf40017000, 0x40000, MEMAREA_FLAG_R|MEMAREA_FLAG_W|MEMAREA_FLAG_G, NULL },
  { 0, 0, 0, 0, NULL },
  { 0, 0, 0, 0, NULL },
  { 0xf7113000, 0xf400c0000, 0x1000, MEMAREA_FLAG_R|MEMAREA_FLAG_W|MEMAREA_FLAG_G|MEMAREA_FLAG_D, NULL },
  { 0xf6800000, 0xf400b4000, 0x8000, MEMAREA_FLAG_R|MEMAREA_FLAG_W|MEMAREA_FLAG_G|MEMAREA_FLAG_D, NULL },
...
__SEC_RO tree_memarea const cpu5_memtree_l_l_l_l = { NULL, NULL, cpu5_memareas + 0 };
__SEC_RO tree_memarea const cpu5_memtree_l_l_l = { &cpu5_memtree_l_l_l_l, NULL, cpu5_memareas + 1 };
__SEC_RO tree_memarea const cpu5_memtree_l_l = { &cpu5_memtree_l_l_l, &cpu5_memtree_l_l_r, cpu5_memareas + 3 };
__SEC_RO tree_memarea const cpu5_memtree_l_l_r = { NULL, NULL, cpu5_memareas + 2 };
__SEC_RO tree_memarea const cpu5_memtree_l = { &cpu5_memtree_l_l, &cpu5_memtree_l_r, cpu5_memareas + 8 };
__SEC_RO tree_memarea const cpu5_memtree_l_r_l_l = { NULL, NULL, cpu5_memareas + 9 };
__SEC_RO tree_memarea const cpu5_memtree_l_r_l = { &cpu5_memtree_l_r_l_l, NULL, cpu5_memareas + 10 };
__SEC_RO tree_memarea const cpu5_memtree_l_r = { &cpu5_memtree_l_r_l, &cpu5_memtree_l_r_r, cpu5_memareas + 13 };
__SEC_RO tree_memarea const cpu5_memtree_l_r_r = { NULL, NULL, cpu5_memareas + 12 };
__SEC_RO tree_memarea const cpu5_memtree = { &cpu5_memtree_l, &cpu5_memtree_r, cpu5_memareas + 25 };
__SEC_RO tree_memarea const cpu5_memtree_r_l_l_l = { NULL, NULL, cpu5_memareas + 26 };
__SEC_RO tree_memarea const cpu5_memtree_r_l_l = { &cpu5_memtree_r_l_l_l, NULL, cpu5_memareas + 17 };
__SEC_RO tree_memarea const cpu5_memtree_r_l = { &cpu5_memtree_r_l_l, &cpu5_memtree_r_l_r, cpu5_memareas + 27 };
__SEC_RO tree_memarea const cpu5_memtree_r_l_r = { NULL, NULL, cpu5_memareas + 16 };
__SEC_RO tree_memarea const cpu5_memtree_r = { &cpu5_memtree_r_l, &cpu5_memtree_r_r, cpu5_memareas + 4 };
__SEC_RO tree_memarea const cpu5_memtree_r_r_l_l = { NULL, NULL, cpu5_memareas + 11 };
__SEC_RO tree_memarea const cpu5_memtree_r_r_l = { &cpu5_memtree_r_r_l_l, NULL, cpu5_memareas + 7 };
__SEC_RO tree_memarea const cpu5_memtree_r_r = { &cpu5_memtree_r_r_l, &cpu5_memtree_r_r_r, cpu5_memareas + 31 };
__SEC_RO tree_memarea const cpu5_memtree_r_r_r = { NULL, NULL, cpu5_memareas + 6 };
__SEC_RO vm_cpu * const cpu5_vm_cpus[0] = {
};
__SEC_RO memarea const cpu6_memareas[32] = {
  { 0x10008000, 0xf40000000, 0x9000, MEMAREA_FLAG_R|MEMAREA_FLAG_X|MEMAREA_FLAG_G, NULL },
  { 0x10011000, 0xf40009000, 0x3000, MEMAREA_FLAG_R|MEMAREA_FLAG_G, NULL },
  { 0x246000, 0xf4000d000, 0x1000, MEMAREA_FLAG_R|MEMAREA_FLAG_W|MEMAREA_FLAG_G, NULL },
  { 0x10014000, 0xf4000c000, 0x1000, MEMAREA_FLAG_R|MEMAREA_FLAG_W|MEMAREA_FLAG_G|MEMAREA_FLAG_S, NULL },
  { 0x10015000, 0xf400c2000, 0x1000, MEMAREA_FLAG_R|MEMAREA_FLAG_G, NULL },
  { 0, 0, 0, 0, NULL },
  { 0x100be000, 0xf50200000, 0x9f3000, MEMAREA_FLAG_R|MEMAREA_FLAG_G, NULL },
  { 0x256000, 0xf400c6000, 0x1000, MEMAREA_FLAG_R|MEMAREA_FLAG_W|MEMAREA_FLAG_G, NULL },
  { 0x10016000, 0xf4000e000, 0x6000, MEMAREA_FLAG_R|MEMAREA_FLAG_G, NULL },
  { 0x24e000, 0xf40014000, 0x1000, MEMAREA_FLAG_R|MEMAREA_FLAG_W|MEMAREA_FLAG_G, NULL },
  { 0x1001d000, 0xf40015000, 0x1000, MEMAREA_FLAG_R|MEMAREA_FLAG_W|MEMAREA_FLAG_G|MEMAREA_FLAG_S, NULL },
  { 0x1001c000, 0xf400c4000, 0x1000, MEMAREA_FLAG_R|MEMAREA_FLAG_G, NULL },
  { 0x200000, 0xf40058000, 0x40000, MEMAREA_FLAG_R|MEMAREA_FLAG_W|MEMAREA_FLAG_G|MEMAREA_FLAG_S, NULL },
  { 0x180000, 0xf40017000, 0x40000, MEMAREA_FLAG_R|MEMAREA_FLAG_W|MEMAREA_FLAG_G, NULL },
  { 0, 0, 0, 0, NULL },
  { 0, 0, 0, 0, NULL },
  { 0xf7113000, 0xf400c0000, 0x1000, MEMAREA_FLAG_R|MEMAREA_FLAG_W|MEMAREA_FLAG_G|MEMAREA_FLAG_D, NULL },
  { 0xf6800000, 0xf400b4000, 0x8000, MEMAREA_FLAG_R|MEMAREA_FLAG_W|MEMAREA_FLAG_G|MEMAREA_FLAG_D, NULL },
...
__SEC_RO tree_memarea const cpu6_memtree_l_l_l_l = { NULL, NULL, cpu6_memareas + 0 };
__SEC_RO tree_memarea const cpu6_memtree_l_l_l = { &cpu6_memtree_l_l_l_l, NULL, cpu6_memareas + 1 };
__SEC_RO tree_memarea const cpu6_memtree_l_l = { &cpu6_memtree_l_l_l, &cpu6_memtree_l_l_r, cpu6_memareas + 3 };
__SEC_RO tree_memarea const cpu6_memtree_l_l_r = { NULL, NULL, cpu6_memareas + 2 };
__SEC_RO tree_memarea const cpu6_memtree_l = { &cpu6_memtree_l_l, &cpu6_memtree_l_r, cpu6_memareas + 8 };
__SEC_RO tree_memarea const cpu6_memtree_l_r_l_l = { NULL, NULL, cpu6_memareas + 9 };
__SEC_RO tree_memarea const cpu6_memtree_l_r_l = { &cpu6_memtree_l_r_l_l, NULL, cpu6_memareas + 10 };
__SEC_RO tree_memarea const cpu6_memtree_l_r = { &cpu6_memtree_l_r_l, &cpu6_memtree_l_r_r, cpu6_memareas + 13 };
__SEC_RO tree_memarea const cpu6_memtree_l_r_r = { NULL, NULL, cpu6_memareas + 12 };
__SEC_RO tree_memarea const cpu6_memtree = { &cpu6_memtree_l, &cpu6_memtree_r, cpu6_memareas + 25 };
__SEC_RO tree_memarea const cpu6_memtree_r_l_l_l = { NULL, NULL, cpu6_memareas + 26 };
__SEC_RO tree_memarea const cpu6_memtree_r_l_l = { &cpu6_memtree_r_l_l_l, NULL, cpu6_memareas + 17 };
__SEC_RO tree_memarea const cpu6_memtree_r_l = { &cpu6_memtree_r_l_l, &cpu6_memtree_r_l_r, cpu6_memareas + 27 };
__SEC_RO tree_memarea const cpu6_memtree_r_l_r = { NULL, NULL, cpu6_memareas + 16 };
__SEC_RO tree_memarea const cpu6_memtree_r = { &cpu6_memtree_r_l, &cpu6_memtree_r_r, cpu6_memareas + 4 };
__SEC_RO tree_memarea const cpu6_memtree_r_r_l_l = { NULL, NULL, cpu6_memareas + 11 };
__SEC_RO tree_memarea const cpu6_memtree_r_r_l = { &cpu6_memtree_r_r_l_l, NULL, cpu6_memareas + 7 };
__SEC_RO tree_memarea const cpu6_memtree_r_r = { &cpu6_memtree_r_r_l, &cpu6_memtree_r_r_r, cpu6_memareas + 31 };
__SEC_RO tree_memarea const cpu6_memtree_r_r_r = { NULL, NULL, cpu6_memareas + 6 };
__SEC_RO vm_cpu * const cpu6_vm_cpus[0] = {
};
__SEC_RO memarea const cpu7_memareas[32] = {
  { 0x10008000, 0xf40000000, 0x9000, MEMAREA_FLAG_R|MEMAREA_FLAG_X|MEMAREA_FLAG_G, NULL },
  { 0x10011000, 0xf40009000, 0x3000, MEMAREA_FLAG_R|MEMAREA_FLAG_G, NULL },
  { 0x247000, 0xf4000d000, 0x1000, MEMAREA_FLAG_R|MEMAREA_FLAG_W|MEMAREA_FLAG_G, NULL },
  { 0x10014000, 0xf4000c000, 0x1000, MEMAREA_FLAG_R|MEMAREA_FLAG_W|MEMAREA_FLAG_G|MEMAREA_FLAG_S, NULL },
  { 0x10015000, 0xf400c2000, 0x1000, MEMAREA_FLAG_R|MEMAREA_FLAG_G, NULL },
  { 0, 0, 0, 0, NULL },
  { 0x100be000, 0xf50200000, 0x9f3000, MEMAREA_FLAG_R|MEMAREA_FLAG_G, NULL },
  { 0x257000, 0xf400c6000, 0x1000, MEMAREA_FLAG_R|MEMAREA_FLAG_W|MEMAREA_FLAG_G, NULL },
  { 0x10016000, 0xf4000e000, 0x6000, MEMAREA_FLAG_R|MEMAREA_FLAG_G, NULL },
  { 0x24f000, 0xf40014000, 0x1000, MEMAREA_FLAG_R|MEMAREA_FLAG_W|MEMAREA_FLAG_G, NULL },
  { 0x1001d000, 0xf40015000, 0x1000, MEMAREA_FLAG_R|MEMAREA_FLAG_W|MEMAREA_FLAG_G|MEMAREA_FLAG_S, NULL },
  { 0x1001c000, 0xf400c4000, 0x1000, MEMAREA_FLAG_R|MEMAREA_FLAG_G, NULL },
  { 0x200000, 0xf40058000, 0x40000, MEMAREA_FLAG_R|MEMAREA_FLAG_W|MEMAREA_FLAG_G|MEMAREA_FLAG_S, NULL },
  { 0x1c0000, 0xf40017000, 0x40000, MEMAREA_FLAG_R|MEMAREA_FLAG_W|MEMAREA_FLAG_G, NULL },
  { 0, 0, 0, 0, NULL },
  { 0, 0, 0, 0, NULL },
  { 0xf7113000, 0xf400c0000, 0x1000, MEMAREA_FLAG_R|MEMAREA_FLAG_W|MEMAREA_FLAG_G|MEMAREA_FLAG_D, NULL },
  { 0xf6800000, 0xf400b4000, 0x8000, MEMAREA_FLAG_R|MEMAREA_FLAG_W|MEMAREA_FLAG_G|MEMAREA_FLAG_D, NULL },
...
__SEC_RO tree_memarea const cpu7_memtree_l_l_l_l = { NULL, NULL, cpu7_memareas + 0 };
__SEC_RO tree_memarea const cpu7_memtree_l_l_l = { &cpu7_memtree_l_l_l_l, NULL, cpu7_memareas + 1 };
__SEC_RO tree_memarea const cpu7_memtree_l_l = { &cpu7_memtree_l_l_l, &cpu7_memtree_l_l_r, cpu7_memareas + 3 };
__SEC_RO tree_memarea const cpu7_memtree_l_l_r = { NULL, NULL, cpu7_memareas + 2 };
__SEC_RO tree_memarea const cpu7_memtree_l = { &cpu7_memtree_l_l, &cpu7_memtree_l_r, cpu7_memareas + 8 };
__SEC_RO tree_memarea const cpu7_memtree_l_r_l_l = { NULL, NULL, cpu7_memareas + 9 };
__SEC_RO tree_memarea const cpu7_memtree_l_r_l = { &cpu7_memtree_l_r_l_l, NULL, cpu7_memareas + 10 };
__SEC_RO tree_memarea const cpu7_memtree_l_r = { &cpu7_memtree_l_r_l, &cpu7_memtree_l_r_r, cpu7_memareas + 13 };
__SEC_RO tree_memarea const cpu7_memtree_l_r_r = { NULL, NULL, cpu7_memareas + 12 };
__SEC_RO tree_memarea const cpu7_memtree = { &cpu7_memtree_l, &cpu7_memtree_r, cpu7_memareas + 25 };
__SEC_RO tree_memarea const cpu7_memtree_r_l_l_l = { NULL, NULL, cpu7_memareas + 26 };
__SEC_RO tree_memarea const cpu7_memtree_r_l_l = { &cpu7_memtree_r_l_l_l, NULL, cpu7_memareas + 17 };
__SEC_RO tree_memarea const cpu7_memtree_r_l = { &cpu7_memtree_r_l_l, &cpu7_memtree_r_l_r, cpu7_memareas + 27 };
__SEC_RO tree_memarea const cpu7_memtree_r_l_r = { NULL, NULL, cpu7_memareas + 16 };
__SEC_RO tree_memarea const cpu7_memtree_r = { &cpu7_memtree_r_l, &cpu7_memtree_r_r, cpu7_memareas + 4 };
__SEC_RO tree_memarea const cpu7_memtree_r_r_l_l = { NULL, NULL, cpu7_memareas + 11 };
__SEC_RO tree_memarea const cpu7_memtree_r_r_l = { &cpu7_memtree_r_r_l_l, NULL, cpu7_memareas + 7 };
__SEC_RO tree_memarea const cpu7_memtree_r_r = { &cpu7_memtree_r_r_l, &cpu7_memtree_r_r_r, cpu7_memareas + 31 };
__SEC_RO tree_memarea const cpu7_memtree_r_r_r = { NULL, NULL, cpu7_memareas + 6 };
__SEC_RO vm_cpu * const cpu7_vm_cpus[0] = {
};
...
__SEC_RW vm_cpu vm_linux1_cpus[1] = {
  { &vm_linux1, (vm_cpu_state *)0xf400c8000, 0,
    0x10074000, 1,
    3, vm_linux1_cpu0_memareas, &vm_linux1_cpu0_memtree,
...
__SEC_RO vm_copyin const vm_linux1_copyins[3] = {
  { 0x40080000, 0xf50200000, 0x851808 },
  { 0x4a000000, 0xf50a51808, 0x199000 },
  { 0x40008000, 0xf50bea808, 0x7ce3 },
};
__SEC_RO capability const vm_linux1_capabilities[0] = {
};
__SEC_RW scheduler_entity vm_linux1_cpu0_scheds[1] = {
...
__SEC_RO memarea const vm_linux1_cpu0_memareas[3] = {
  { 0x40000000, 0x0, 0x40000000, MEMAREA_FLAG_R|MEMAREA_FLAG_W|MEMAREA_FLAG_X, cpu0_memareas + 32 },
...
__SEC_RO tree_memarea const vm_linux1_cpu0_memtree_l = { NULL, NULL, vm_linux1_cpu0_memareas + 0 };
...
__SEC_RO tree_memarea const vm_linux1_cpu0_memtree_r = { NULL, NULL, vm_linux1_cpu0_memareas + 1 };
__SEC_RO emulate const vm_linux1_cpu0_emulates[13] = {
