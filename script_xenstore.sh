...
./xenstore-chmod /local/domain/1/device rw
./xenstore-write /local/domain/1/device/vif ""
./xenstore-chmod /local/domain/1/device/vif rw
./xenstore-write /local/domain/1/device/vif/0 ""
./xenstore-chmod /local/domain/1/device/vif/0 rw
./xenstore-write /local/domain/1/device/vif/0/backend-id 0
./xenstore-chmod /local/domain/1/device/vif/0/backend-id r
./xenstore-write /local/domain/1/device/vif/0/mac "D2:A3:CD:27:4A:53"
./xenstore-chmod /local/domain/1/device/vif/0/mac rw
./xenstore-write /local/domain/1/device/vif/0/backend "/local/domain/0/backend/vif/1/0"
./xenstore-chmod /local/domain/1/device/vif/0/backend rw
...
./xenstore-chmod /local/domain/0/backend/vif/1/0 rw
